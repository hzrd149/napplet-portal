...
> = {
  shell: {
    ...
    partial: "tests/shell_resilience_test.tsx",
    ...
    "mixed-settlement": "tests/shell_resilience_test.tsx",
  },
  identity: {
    ...
    shutdown: "tests/websocket_session_test.ts",
    "mixed-settlement": "tests/identity_service_test.ts",
  },
  relay: {
    ...
    "mixed-settlement": "tests/relay_stream_test.ts",
  },
  outbox: {
    normal: "tests/identity_service_test.ts",
    empty: "tests/identity_service_test.ts",
    partial: "tests/identity_service_test.ts",
    stale: "tests/adversarial_authority_test.ts",
    denied: "tests/adversarial_authority_test.ts",
    timeout: "tests/identity_service_test.ts",
    reconnect: "tests/lifecycle_matrix_test.ts",
    replacement: "tests/lifecycle_matrix_test.ts",
    shutdown: "tests/lifecycle_matrix_test.ts",
    "mixed-settlement": "tests/identity_service_test.ts",
  ...
  upload: {
    normal: "tests/nap_dispatcher_test.ts",
    empty: "tests/resource_service_test.ts",
    partial: "tests/resource_service_test.ts",
    stale: "tests/adversarial_transport_transfer_test.ts",
    denied: "tests/resource_policy_test.ts",
    ...
    replacement: "tests/adversarial_transport_transfer_test.ts",
    shutdown: "tests/binary_transport_test.ts",
    "mixed-settlement": "tests/nap_dispatcher_test.ts",
  },
  common: {
    normal: "tests/common_runtime_integration_test.ts",
    empty: "tests/common_test.ts",
    partial: "tests/common_test.ts",
    stale: "tests/adversarial_authority_test.ts",
    denied: "tests/adversarial_authority_test.ts",
    timeout: "tests/common_test.ts",
    reconnect: "tests/lifecycle_matrix_test.ts",
    replacement: "tests/adversarial_authority_test.ts",
    shutdown: "tests/websocket_session_test.ts",
    "mixed-settlement": "tests/common_test.ts",
  },
  storage: {
    normal: "tests/storage_test.ts",
    empty: "tests/storage_test.ts",
    partial: "tests/common_storage_runtime_test.ts",
    stale: "tests/adversarial_state_isolation_test.ts",
    denied: "tests/adversarial_state_isolation_test.ts",
    timeout: "tests/storage_test.ts",
    reconnect: "tests/lifecycle_matrix_test.ts",
    replacement: "tests/adversarial_state_isolation_test.ts",
    shutdown: "tests/storage_test.ts",
    "mixed-settlement": "tests/storage_test.ts",
  },
  intent: {
  ...
  media: {
    ...
    stale: "tests/media_transport_test.ts",
    denied: "tests/media_sessions_test.ts",
    ...
    "mixed-settlement": "tests/media_sessions_test.ts",
  },
};
